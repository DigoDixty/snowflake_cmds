CREATE OR REPLACE PROCEDURE public.crete_tasks_parquet(schemaname string , table_name string, stage string, v_warehouse string, file_name string, file_format string)
RETURNS string
LANGUAGE SQL
AS $$
DECLARE
